r"""
CreditosPro OWNER TOOL — Solo para Johan Garcia
Guarda en C:\Users\johan\MisTool\
"""
import sys, argparse, hashlib, json, base64, datetime, uuid, socket
...
def generate_license(machine_id, empresa_id, empresa_nombre, dias=365):
    from cryptography.fernet import Fernet
    f = Fernet(_derive_key(MASTER_SECRET))
    payload = json.dumps({
...
def main():
    ...
    if args.cmd == "generate":
        ...
        # Tambien guardar en archivo para facil copia
